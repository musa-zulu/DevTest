# Regenesys Onion architecture with ASP.NET Core
...
<p align="center">
  ...
  <p align="center">
    Regenesys API solution is built on Onion Architecture with all essential feature using .NET Core!
  </p>
</p>
...
This Regenesys api contains following features.
